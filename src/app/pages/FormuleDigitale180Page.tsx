      ...
      <section className="relative min-h-[70vh] flex items-center pt-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-4xl">
            ...
            >
              <strong className="font-bold text-purple-300">Gestion 100% digitale</strong> de votre bien situé partout en France métropolitaine ou DOM-TOM.
            ...
            <div className="bg-white rounded-3xl shadow-2xl border-4 border-purple-200 p-10 text-center">
              ...
              <div className="bg-purple-50 rounded-2xl p-6 mb-8">
                <div className="text-lg text-gray-700 mb-4">
                  <strong className="text-purple-700">86 propriétaires</strong> en France et DOM-TOM nous font confiance
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              {
                title: 'Propriétaire à distance',
                description: 'Votre bien est situé en France ou DOM-TOM, vous ne pouvez pas gérer au quotidien',
                icon: Globe
              },
              {
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-lg border-2 border-purple-200 p-8">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">France & DOM-TOM</span>
                </li>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              Gestion Airbnb digitale 180€/mois : La solution pour propriétaires partout en France et DOM-TOM
            </h2>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Notre <strong>Formule Digitale à 180€/mois TTC</strong> est la solution idéale pour les propriétaires qui souhaitent déléguer la <strong>gestion digitale complète</strong> de leur bien Airbnb sans intervention terrain. Avec <strong>86 biens gérés</strong> partout en France métropolitaine et DOM-TOM, nous sommes experts de la gestion locative à distance.
            </p>
