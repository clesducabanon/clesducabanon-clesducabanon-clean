...
export function ConciergerieHyeresPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <motion.div
              ...
              className="p-6 rounded-2xl text-center" style={{ background: 'rgba(201,168,76,0.07)', border: '1px solid rgba(201,168,76,0.2)' }}
            >
      ...
      {/* CTA Final */}
      <section className="py-16" style={{ background: 'linear-gradient(135deg, #1a2744, #0AADA3)' }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Propriétaire d'une villa à Hyères ou Giens ?
          </h2>
          <p className="text-xl text-white/90 mb-8">
            Rejoignez nos propriétaires qui nous font confiance et génèrent jusqu'à 35% de revenus en plus
          </p>
          <button
            onClick={scrollToContact}
