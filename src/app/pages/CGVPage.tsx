          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 space-y-10">
              ...
              <div className="bg-gray-50 rounded-xl p-6 space-y-4">
                ...
                <div className="space-y-3 ml-4">
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-teal-600 mt-1 flex-shrink-0" />
                    <div>
                      <p className="font-bold text-gray-900">Formule Premium Appartement (25% TTC)</p>
                      <p className="text-gray-700">Zone Côte Varoise (Sanary à Hyères) : Gestion complète pour appartements incluant remise des clés, états des lieux, coordination ménage, maintenance, intervention terrain 24/7.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section>
              ...
              <div className="bg-gray-50 rounded-xl p-6 space-y-4">
                ...
                <div>
                  <p className="font-bold text-gray-900 mb-2">3.2 - Formule Premium Appartement (25% TTC)</p>
                  <p className="text-gray-700">La commission est de <strong>25% TTC</strong> calculée sur le montant des réservations encaissées pour les appartements (hors frais de ménage et frais de service Airbnb/Booking).</p>
                </div>
