    ...
    <section id="comment-ca-marche" className="py-24 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          ...
          <div className="hidden lg:block absolute top-20 left-0 right-0 h-0.5 -z-0" style={{ background: 'linear-gradient(90deg, rgba(10,173,163,0.3), rgba(201,168,76,0.3), rgba(10,173,163,0.3), rgba(26,39,68,0.3))' }}></div>
        ...
        >
          <button
            ...
            className="px-10 py-4 rounded-full font-bold text-lg hover:shadow-2xl transition-all inline-flex items-center gap-3 group text-white hover:scale-105"
            style={{ background: 'linear-gradient(135deg, #C9A84C, #A07D2A)', boxShadow: '0 8px 28px rgba(201,168,76,0.35)' }}
          >
            Démarrer maintenant
