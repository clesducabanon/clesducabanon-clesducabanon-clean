        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl h-64">
              ...
              />
              <div className="absolute inset-0" style={{ background: 'linear-gradient(to top, rgba(26,39,68,0.70), transparent)' }}></div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200 flex items-start gap-4 hover:shadow-xl transition-shadow">
                <div className="p-3 rounded-xl" style={{ background: 'rgba(10,173,163,0.12)' }}>
                  <MapPin className="w-6 h-6" style={{ color: '#0AADA3' }} />
                </div>
                <div>
            ...
            {/* Response Time Badge */}
            <div className="rounded-2xl p-6 text-white text-center" style={{ background: 'linear-gradient(135deg, #0AADA3, #087A72)' }}>
              <div className="text-4xl font-bold mb-2">⏱️ Moins de 24h</div>
              <p className="text-white/75">Temps de réponse moyen</p>
            </div>
          </motion.div>
        </div>
      </div>
