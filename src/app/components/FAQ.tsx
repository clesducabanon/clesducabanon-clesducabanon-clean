...
const faqs = [
  {
    ...
    answer: 'Notre commission est de 20% TTC pour les villas et 25% TTC pour les appartements sur vos revenus locatifs effectifs. Cette commission unique couvre l\'ensemble de nos services : gestion des réservations, communication avec les voyageurs, remise des clés, états des lieux, photos professionnelles, tarification dynamique, intervention terrain 7j/7, et bien plus encore.',
  },
  {
  ...
  {
    question: 'Faut-il une boîte à clé ou une serrure connectée ?',
    answer: 'Oui. Pour les appartements, la boîte à clé sécurisée ou la serrure connectée est obligatoire : elle permet un accès autonome et sécurisé des voyageurs à toute heure, sans dépendre d\'un tiers. Pour les villas, elle est fortement recommandée pour votre sécurité et la fluidité des arrivées — nous la demandons systématiquement. Ces équipements garantissent des check-in flexibles et zéro risque de perte de clés.',
  },
  {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <motion.div
              ...
              style={{ boxShadow: '0 2px 12px rgba(26,39,68,0.06)', border: '1px solid rgba(201,168,76,0.15)' }}
            >
              <button
        ...
        <motion.div
          ...
          className="mt-12 rounded-3xl p-8 text-center text-white"
            style={{ background: 'linear-gradient(135deg, #1a2744, #0AADA3)' }}
        >
