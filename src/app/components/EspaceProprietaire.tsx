        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:hidden space-y-6">
            ...
            >
              ...
              <div className="text-3xl font-bold mb-2 text-center">2 100€/mois</div>
              <div className="text-sm text-purple-100 text-center mb-4">France & DOM-TOM</div>
              <div className="bg-white/20 border border-white/30 rounded-xl p-4">
                <div className="text-center mb-3">
          ...
          <div>
            ...
            >
              <div className="flex items-center justify-center gap-3">
                ...
                <h3 className="text-3xl font-bold">Formule Digitale 180€ - France & DOM-TOM</h3>
              </div>
