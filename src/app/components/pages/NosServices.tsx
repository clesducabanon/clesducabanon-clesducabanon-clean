  ...
  return (
    <>
      <SEOHead
        ...
        description="Comparez nos 2 formules de gestion Airbnb : Premium 20% TTC (Sanary/Hyères) avec gestion terrain complète, ou Digitale 180€/mois (France & DOM-TOM) pour gestion à distance. 128 clients satisfaits."
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="mt-8 inline-flex items-center gap-2 bg-yellow-400/20 backdrop-blur-sm px-6 py-3 rounded-full font-bold">
                ...
                <span>28 propriétaires nous font confiance</span>
              </div>
            </motion.div>
          </div>
        </section>
            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-0">
                ...
                <div className="p-8 bg-gradient-to-br from-blue-500 to-teal-500 text-white">
                  ...
                  <div className="text-xs opacity-75">28 propriétaires</div>
                </div>
                ...
                <div className="p-8 bg-gradient-to-br from-purple-500 to-pink-500 text-white">
                  ...
                  <div className="text-sm opacity-90 mb-2">France & DOM-TOM</div>
                  <div className="text-xs opacity-75">86 propriétaires</div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-12">
                ...
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-10 rounded-3xl border border-purple-200">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900">
                      Formule Digitale 180€ - France & DOM-TOM
                    </h3>
                  </div>

                  <p className="text-gray-700 leading-relaxed mb-6">
                    Notre <strong>formule Digitale à 180€/mois</strong> s'adresse aux propriétaires partout en <strong>France métropolitaine et DOM-TOM</strong>
                  ...
                  <ul className="space-y-3 text-gray-700">
                    ...
                    <li className="flex items-start gap-2">
                      <Check className="w-5 h-5 text-purple-600 flex-shrink-0 mt-1" />
                      <span><strong>Tarification dynamique</strong> adaptée à votre marché local (Paris, Lyon, Bordeaux, Marseille, Martinique, Guadeloupe, Réunion...)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="w-5 h-5 text-purple-600 flex-shrink-0 mt-1" />
              ...
              <div className="space-y-6">
                {[
                  ...
                  },
                  {
                    ...
                    a: 'Oui ! Nous gérons des biens en <strong>France métropolitaine</strong> (Paris, Lyon, Bordeaux, Marseille, Nice, Toulouse...) et <strong>DOM-TOM</strong> (Martinique, Guadeloupe, Réunion, Mayotte...). La gestion digitale fonctionne de la même façon partout.',
                  },
                  {
