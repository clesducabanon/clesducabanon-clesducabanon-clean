  ...
  return (
    <div className="pt-20 min-h-screen bg-white">
      <SEOHead
        ...
        description="Conciergerie digitale 180€/mois pour gérer votre location Airbnb à Paris, Lyon, Marseille, Guadeloupe, Martinique, La Réunion. Gestion complète à distance sans intervention terrain. 86 propriétaires satisfaits."
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <p className="text-sm text-blue-100 mt-6">
            ⚡ Mise en service sous 48h • Sans engagement • 86 propriétaires nous font confiance
          </p>
        </motion.div>
      </article>
    </div>
