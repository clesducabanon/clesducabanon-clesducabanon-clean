...
const blogArticles = [
  ...
  },
  {
    ...
    content: `
      ...
      <p>Chez Les Clés du Cabanon : <strong>20% TTC pour les villas</strong> et <strong>25% TTC pour les appartements</strong> — gestion complète terrain incluse, de Sanary à Hyères.</p>
  ...
  },
  {
    ...
    title: 'Comment maximiser vos revenus Airbnb sur la Côte Varoise : Guide Complet',
    excerpt: 'Propriétaire entre Sanary et Hyères ? Découvrez comment notre formule Premium (Villa 20% / Appartement 25%) optimise vos revenus locatifs.',
    image: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
    date: '15 Mars 2026',
    author: 'Guillaume & Erika',
    category: 'Gestion Premium',
    readTime: '8 min',
