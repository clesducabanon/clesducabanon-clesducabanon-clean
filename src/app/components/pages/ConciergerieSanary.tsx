...
const faqsSanary = [
  ...
  },
  {
    ...
    answer: 'Notre Formule Premium est transparente : 20% TTC pour les villas et 25% TTC pour les appartements, calculés sur vos revenus locatifs effectifs. Cette commission inclut la gestion complète : annonces, réservations, communication voyageurs 24/7, remise des clés, états des lieux, ménage coordonné, maintenance et intervention terrain 7j/7. Les frais de ménage et blanchisserie sont payés directement par les voyageurs.',
  },
  {
...
export function ConciergerieSanary({ setCurrentPage }: ConciergerieSanaryProps) {
  ...
  return (
    <div className="pt-20">
      ...
      {/* Hero Section */}
      <section className="relative text-white py-20" style={{ background: 'linear-gradient(135deg, #1a2744 0%, #0AADA3 100%)' }}>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  'Boîte à clé sécurisée ou serrure connectée (obligatoire pour appartements, demandée pour villas)',
            ...
            <div className="p-10 rounded-3xl text-white shadow-2xl" style={{ background: 'linear-gradient(135deg, #1a2744, #0AADA3)' }}>
      ...
      {/* CTA Final */}
      <section className="py-20" style={{ background: 'linear-gradient(135deg, #1a2744, #0AADA3)' }}>
