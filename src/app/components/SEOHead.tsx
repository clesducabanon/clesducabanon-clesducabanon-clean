...
export const getLocalBusinessSchema = () => ({
  ...
  priceRange: '€€',
  description:
    'Conciergerie premium spécialisée en gestion complète de villas et appartements Airbnb. 2 formules: Premium 20% TTC (Sanary/Hyères) avec intervention terrain, Digitale 180€/mois (France & DOM-TOM). Tarification dynamique, Superhôte 4.9/5. 128 propriétaires satisfaits.',
  areaServed: [
    'Sanary-sur-Mer',
    'Hyères',
    'Giens',
    ...
    itemListElement: [
      ...
      },
      {
        ...
        itemOffered: {
          ...
          description:
            'Gestion à distance pour biens en France et DOM-TOM : annonces optimisées, tarification dynamique, communication voyageurs 24/7, calendrier synchronisé, photos professionnelles. Vous gérez les clés et le ménage. 86 propriétaires satisfaits.',
          provider: {
            '@type': 'LocalBusiness',
            name: 'Les Clés du Cabanon',
          },
