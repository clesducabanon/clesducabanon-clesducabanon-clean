...
export const getLocalBusinessSchema = () => ({
  ...
  priceRange: '€€',
  description:
    'Conciergerie premium spécialisée en gestion complète de villas et appartements Airbnb. Formule Premium : Villa 20% TTC · Appartement 25% TTC. Intervention terrain complète, Sanary à Hyères. Tarification dynamique, Superhôte 4.9/5. 28 propriétaires satisfaits.',
  areaServed: [
    'Sanary-sur-Mer',
    'Hyères',
    'Giens',
    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          description:
            'Gestion 100% complète de votre villa ou appartement à Sanary-sur-Mer et Hyères : création annonces, tarification dynamique, communication 24/7, remise clés, états des lieux, coordination ménage, intervention terrain 7j/7. 28 propriétaires satisfaits.',
          provider: {
            '@type': 'LocalBusiness',
      ...
      },
      {
        ...
        itemOffered: {
          '@type': 'Service',
          name: 'Formule Premium Appartement 25% TTC',
          description:
            'Gestion 100% complète de votre appartement à Sanary-sur-Mer et Hyères : création annonces, tarification dynamique, communication 24/7, remise clés, états des lieux, coordination ménage, intervention terrain 7j/7.',
          provider: {
            '@type': 'LocalBusiness',
            name: 'Les Clés du Cabanon',
          },
