...
const digitalZones = [
  { region: 'France Métropolitaine', clients: 47, color: 'from-blue-500 to-purple-500', emoji: '🇫🇷' },
  { region: 'DOM-TOM', clients: 39, color: 'from-teal-500 to-cyan-500', emoji: '🌴' },
];
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-4">
              Gestion digitale optimisée <strong className="text-purple-600">partout en France et DOM-TOM</strong> : vous gérez le terrain, nous gérons le digital.
            </p>
            ...
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-3 rounded-full font-bold">
              ...
              <span>86 propriétaires nous font confiance</span>
            </div>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  <strong> Idéal pour la France métropolitaine et DOM-TOM !</strong>
                </p>
              </div>
            </div>
          </motion.div>
